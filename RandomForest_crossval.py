...
for n_estimators in tqdm(range(42, 51)):
...
RandomForest_Full_Results.sort_values(by=['test_score'], inplace=True, ascending=False)
RandomForest_Full_Results = RandomForest_Full_Results.round(3)
